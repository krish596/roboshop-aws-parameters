parameters = {
 ...
 # Elastic Search
  ...
  "docdb.prod.endpoint" = { type = "String", value = "dev-docdb-cluster-instance-1.c3w48kiu8jbe.us-east-1.docdb.amazonaws.com" }
  "rds.prod.master_username" = { type = "String", value = "devadmin" }
  "rds.prod.database_name" = { type = "String", value = "dummy" }
  "user.prod.REDIS_HOST" = { type = "String", value = "dev-redis-elasticache-cluster.obyypp.0001.use1.cache.amazonaws.com" }
  "cart.prod.REDIS_HOST" = { type = "String", value = "dev-redis-elasticache-cluster.obyypp.0001.use1.cache.amazonaws.com" }
  ...
  "shipping.prod.DB_HOST" = { type = "String", value = "dev-mysql-rds-cluster.cluster-c3w48kiu8jbe.us-east-1.rds.amazonaws.com" }
